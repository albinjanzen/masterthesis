...
path_to_raw = '../data/Raw/SMHI/temperature/'
...
#         'https://opendata-download-metobs.smhi.se/api/version/latest/parameter/1/station/' + str(station) + '/period/corrected-archive/data.csv')
...
for station in stations:
    ...
    temporary.rename(
        columns={'Lufttemperatur': str(station)+'_temp'}, inplace=True)
